...
import { CFG } from './config.js?v=37.0.0';
import { STAGES } from './stages.js?v=37.0.0';
import { createSky } from './sky.js?v=37.0.0';
import { createTerrainSystem, getTerrainY } from './terrain.js?v=37.0.0';
import { makeSkier } from './skier.js?v=37.0.0';
import { createEnvironment } from './environment.js?v=37.0.0';
import { createDiamondArchSystem } from './diamondArch.js?v=37.0.0';
import { createKickerRampSystem } from './kickerRamp.js?v=37.0.0';
import { createSpawnManager } from './spawnManager.js?v=37.0.0';
import { createDriftSystem } from './driftSystem.js?v=37.0.0';
import { setupUI } from './ui.js?v=37.0.0';
import { i18n, getLang, setLang, t, getFlagEmoji } from './i18n.js?v=37.0.0';
import { createAvalancheSystem } from './avalancheSystem.js?v=37.0.0';
import { updateOpeningCutscene, updateVictoryCeremony } from './cinematic.js?v=37.0.0';
import { soundFx } from './soundSystem.js?v=37.0.0';
import { loadSelectedCharacter } from './characters.js?v=37.0.0';
import { createSnowballHazardSystem } from './snowballHazard.js?v=37.0.0';
import { createRockySnowballHazardSystem } from './rockySnowballHazard.js?v=37.0.0';
import { createMedalRampSystem } from './medalRamp.js?v=37.0.0';
import { triggerMedalFlyToScoreAnimation } from './medalAnimation.js?v=37.0.0';
import { submitLeaderboardScoreData } from './leaderboard.js?v=37.0.0';
import { createBirdHazardSystem } from './birdHazard.js?v=37.0.0';
import { createExplodingSnowballHazardSystem } from './explodingSnowballHazard.js?v=37.0.0';
